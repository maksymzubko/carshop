    ...
    if ($_SESSION['lang'] == 'ru')
        ...
        if ($_SESSION['lang'] == 'ukr') {
            $action = array(
                ...
                "Неправильный формат!"=>"Невірний формат!"
            );
        } else {
            $action = array(
                "И еще"=>"And",
                "автомобилей"=>"more cars",
                "Пользователь уже зарегистрирован!" => "User is already register",
                ...
                "Пароли не совпадают!"=>"Passwords not match!",
